...
from zohosdk.src.com.zoho.officeintegrator.v1 import DocumentSessionDeleteSuccessResponse, \
    InvalidConfigurationException, CreatePresentationParameters, SessionDeleteSuccessResponse
...
class DeletePresentationSession:
    ...
    @staticmethod
    def execute():
        DeletePresentationSession.init_sdk()
        createPresentationParams = CreatePresentationParameters()

        print('Creating a presentation to demonstrate presentation session delete api')
        ...
        if response is not None:
            ...
            if responseObject is not None:
                if isinstance(responseObject, CreateDocumentResponse):
                    ...
                    print('Presentation Session ID to be deleted : ' + documentSessionId)

                    deleteApiResponse = v1Operations.delete_presentation_session(documentSessionId)
                    ...
                    if deleteApiResponse is not None:
                        ...
                        if deleteResponseObject is not None:
                            if isinstance(deleteResponseObject, SessionDeleteSuccessResponse):
                                print('Presentation Session delete status : ' + str(deleteResponseObject.get_session_delete()))
                                ...
                                print('Delete Presentation Session Request Failed')
